...
<head>
    ...
    <title>503 - الموقع تحت الصيانة | Ascend Academy</title>
    <!-- Google Fonts -->
...
<body>
    <div class="container">
        ...
        <div class="error-card">
            ...
            <p>
                نقوم حالياً بإجراء بعض التحديثات الدورية وتحسين الأداء لنقدم لكم تجربة تعليمية متميزة. سنعود للعمل مجدداً خلال دقائق معدودة، شكراً لتعاونكم وتفهمكم.
            </p>
            ...
            <span class="lang-text">Be Right Back. We are currently performing scheduled maintenance.</span>
        </div>
    </div>
</body>
</html>
