...
<head>
    ...
    <title>403 - غير مصرح بالدخول | Ascend Academy</title>
    <!-- Google Fonts -->
...
<body>
    <div class="container">
        ...
        <div class="error-card">
            ...
            <p>
                عذراً، ليس لديك الصلاحيات الكافية للوصول إلى هذه الصفحة. يرجى تسجيل الدخول بحساب يمتلك الصلاحية المطلوبة.
            </p>
            ...
            <span class="lang-text">Access Forbidden. You do not have permission to access this page.</span>
        </div>
    </div>
</body>
</html>
