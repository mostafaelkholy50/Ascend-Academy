...
<head>
    ...
    <title>500 - خطأ داخلي في الخادم | Ascend Academy</title>
    <!-- Google Fonts -->
...
<body>
    <div class="container">
        ...
        <div class="error-card">
            ...
            <p>
                عذراً، حدثت مشكلة غير متوقعة أثناء معالجة طلبك. لقد تم إبلاغ مهندسينا بالمشكلة، ونعمل الآن على إصلاحها لتقديم أفضل تجربة ممكنة.
            </p>
            ...
            <span class="lang-text">Internal Server Error. Our team is working to fix the issue.</span>
        </div>
    </div>
</body>
</html>
