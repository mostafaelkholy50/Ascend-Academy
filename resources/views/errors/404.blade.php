...
<head>
    ...
    <title>404 - الصفحة غير موجودة | Ascend Academy</title>
    <!-- Google Fonts -->
    ...
    <style>
        ...
        * {
        ...
        .brand-title span {
            color: #ffd700; /* Golden text for Quran accent in dark top banner */
        }
...
<body>
    <div class="container">
        ...
        <div class="error-card">
            ...
            <p>
                عذراً، الصفحة التي تبحث عنها قد تم نقلها، حذفها، أو أنها لم تكن موجودة في الأصل. يرجى التأكد من صحة الرابط.
            </p>
            ...
            <span class="lang-text">Page Not Found. Please check the URL or return to home.</span>
        </div>
    </div>
</body>
</html>
