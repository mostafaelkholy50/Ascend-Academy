...
<head>
    ...
    <title>419 - انتهت صلاحية الصفحة | Ascend Academy</title>
    <!-- Google Fonts -->
...
<body>
    <div class="container">
        ...
        <div class="error-card">
            ...
            <h1>انتهت صلاحية الصفحة</h1>
            
            <p>
                عذراً، لقد بقيت هذه الصفحة خاملة لفترة طويلة جداً دون تفاعل. يرجى تحديث الصفحة وإعادة المحاولة مجدداً.
            </p>
            ...
            <span class="lang-text">Page Expired. Your CSRF token is invalid. Please reload the page.</span>
        </div>
    </div>
</body>
</html>
