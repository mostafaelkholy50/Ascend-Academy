    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-gradient-to-br from-white to-indigo-50/30 rounded-3xl shadow-lg p-6 md:p-8 border border-indigo-100 print-card">
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center space-x-6">
                        ...
                        <div>
                            <p class="text-xs font-bold text-indigo-600 uppercase tracking-wide mb-1">Student Assessed</p>
                            ...
                            @if($studentEvaluation->course)
                                <div class="mt-3 inline-flex items-center bg-gradient-to-r from-indigo-100/50 to-purple-100/50 px-3 py-1.5 rounded-lg border border-indigo-100">
                                    ...
                                    <span class="font-bold text-indigo-800 text-xs">{{ $studentEvaluation->course->title }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
        ...
        <div class="space-y-6 no-print">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gradient-to-r from-emerald-50/50 to-green-50/50 rounded-xl p-4 border border-emerald-50">
                        <p class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1">Teacher</p>
                        <p class="text-sm font-bold text-gray-800">{{ $studentEvaluation->teacher->name }}</p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-3xl shadow-lg p-6 text-white">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.student-evaluations.index') }}" class="block w-full bg-white/20 hover:bg-white/30 px-4 py-3 rounded-xl transition-all duration-200 text-center font-semibold border border-white/20">
                        <i class="fa-solid fa-list mr-2"></i>All Evaluations Index
                    </a>
                    <a href="{{ route('admin.dashboard') }}" class="block w-full bg-white text-indigo-700 hover:bg-indigo-50 px-4 py-3 rounded-xl transition-all duration-200 text-center font-semibold shadow-md">
                ...
                @if($recentEvals->count() > 0)
                    <div class="space-y-3">
                        @foreach($recentEvals as $recentEval)
                            <a href="{{ route('admin.student-evaluations.show', $recentEval->id) }}" 
