    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                    ...
                    <a href="{{ route('admin.profile.edit') }}" class="w-full sm:w-auto text-center px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 font-semibold">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap justify-center sm:justify-start items-center gap-3">
                            <span class="px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 rounded-xl font-bold text-sm">
                                <i class="fa-solid fa-user-graduate mr-1"></i>Admin
                            </span>
        ...
        <div class="space-y-6">
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            <p class="text-white/80 text-sm mb-1">Total Users</p>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            <p class="text-white/80 text-sm mb-1">Total Teachers</p>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.profile.edit') }}" class="block w-full bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-blue-700 px-4 py-3 rounded-xl transition-all font-semibold text-center">
                        <i class="fa-solid fa-user-edit mr-2"></i>Edit Profile
                    </a>
                    <a href="{{ route('admin.dashboard') }}" class="block w-full bg-gradient-to-r from-green-100 to-emerald-100 hover:from-green-200 hover:to-emerald-200 text-green-700 px-4 py-3 rounded-xl transition-all font-semibold text-center">
