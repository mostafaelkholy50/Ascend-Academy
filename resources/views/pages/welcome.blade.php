    ...
    <section class="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <picture>
                ...
                <img src="{{ asset('assets/images/WhatsApp Image 2025-12-18 at 5.26.06 AM.jpeg') }}" alt="Background"
    ...
    <section class="py-24 bg-white">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            ...
            <div class="flex flex-wrap justify-center gap-4 sm:gap-8">
                <div
                    class="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border-t-4 border-[#1E90A0] hover:shadow-2xl transition duration-300 transform hover:-translate-y-1 text-center flex-1 min-w-[280px] max-w-[350px]">
                    ...
                    <p class="text-gray-600 text-sm sm:text-base">Master Tajweed and accurate Quran recitation through
                        step-by-step personalized guidance.</p>
                </div>
                <div
                    class="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border-t-4 border-[#1E90A0] hover:shadow-2xl transition duration-300 transform hover:-translate-y-1 text-center flex-1 min-w-[280px] max-w-[350px]">
                ...
                <div class="grid md:grid-cols-2 gap-8 mb-8">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Choose from 1 to 7 days per week based on your availability and
                                learning goals.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Select 30-minute or 1-hour sessions to match your child's attention
                                span and learning pace.</p>
                        </div>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-12">
                <h3
                    ...
                    Meet Our Certified Teachers</h3>
            ...
            <div class="flex space-x-6 overflow-x-auto pb-6 scrollbar-hide">
                @forelse($teachers as $teacher)
                    <div
                        class="flex-shrink-0 w-72 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden text-center group cursor-pointer">
                        <div class="relative">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-gray-600 mt-4 text-lg max-w-xl">
                        Enjoy a free one-on-one session with a friendly certified teacher — perfect for both kids and
                        adults.
                    </p>
