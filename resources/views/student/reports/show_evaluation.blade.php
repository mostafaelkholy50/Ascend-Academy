<x-dashboard-layout title="Monthly Evaluation Details">
    ...
    <div class="mb-8 no-print">
        <div class="flex items-center justify-between">
            ...
            <button onclick="window.print()" class="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-5 py-3 rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-200 font-semibold flex items-center gap-2">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            <!-- Header Summary Card -->
            <div class="bg-gradient-to-br from-white to-teal-50/30 rounded-3xl shadow-lg p-6 md:p-8 border border-teal-100 print-card">
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div class="flex items-center space-x-6">
                        <div class="relative">
                            <div class="h-20 w-20 rounded-2xl bg-gradient-to-br from-teal-400 via-emerald-500 to-cyan-500 flex items-center justify-center text-white font-bold text-3xl shadow-xl">
                                {{ strtoupper(substr($evaluation->teacher->name, 0, 1)) }}
                            </div>
                            <div class="absolute -bottom-2 -right-2 bg-teal-600 rounded-full p-2 shadow-lg">
                                <i class="fa-solid fa-user-tie text-white text-sm"></i>
                            </div>
                        </div>
                        <div>
                            <p class="text-xs font-bold text-teal-600 uppercase tracking-wide mb-1">Assessed By Teacher</p>
                            ...
                            @if($evaluation->course)
                                <div class="mt-3 inline-flex items-center bg-gradient-to-r from-teal-100/50 to-cyan-100/50 px-3 py-1.5 rounded-lg border border-teal-100">
                                    <i class="fa-solid fa-book text-teal-600 mr-2"></i>
                                    <span class="font-bold text-teal-800 text-xs">{{ $evaluation->course->title }}</span>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- Level Badge -->
                    <div class="text-center bg-white rounded-2xl p-4 border border-teal-100/80 shadow-sm print-gradient min-w-[120px]">
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-8 mb-6">
                    <div>
                        <h3 class="text-xl font-bold text-gray-800 flex items-center mb-2">
                            <div class="bg-gradient-to-br from-teal-600 to-cyan-600 p-2.5 rounded-xl mr-3 shadow-md">
                        ...
                        <div class="mt-6">
                            <span class="px-4 py-2 bg-gradient-to-r {{ $evaluation->total_score >= 90 ? 'from-green-50 to-emerald-100 text-green-700 border-green-200' : ($evaluation->total_score >= 80 ? 'from-teal-50 to-cyan-100 text-teal-700 border-teal-200' : ($evaluation->total_score >= 70 ? 'from-blue-50 to-indigo-100 text-blue-700 border-blue-200' : ($evaluation->total_score >= 60 ? 'from-yellow-50 to-amber-100 text-yellow-700 border-yellow-200' : 'from-red-50 to-rose-100 text-red-700 border-rose-200'))) }} rounded-xl font-bold border text-sm shadow-sm">
                                Rating: 
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @foreach($questions as [$field, $title, $icon, $textClass, $gradient])
                        ...
                        @endphp
                        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-teal-200 transition-all duration-200 flex flex-col justify-between print-card">
            ...
            <!-- Teacher Notes -->
            @if($evaluation->notes)
                <div class="bg-gradient-to-br from-teal-50/30 to-emerald-50/30 rounded-3xl shadow-lg p-6 md:p-8 border border-teal-100 print-card">
                    <div class="flex items-center mb-4">
                        <div class="bg-gradient-to-br from-teal-500 to-emerald-600 p-2.5 rounded-xl mr-3 shadow-md">
                            <i class="fa-solid fa-comment-dots text-white"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-800">Teacher's Remarks</h3>
                    </div>
                    <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-teal-100/50 shadow-inner">
                        <i class="fa-solid fa-quote-left text-teal-400/30 text-4xl block mb-2 -ml-2"></i>
        ...
        <div class="space-y-6 no-print">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                <h3 class="text-lg font-bold text-gray-800 mb-6 flex items-center">
                    <i class="fa-solid fa-clipboard-check text-teal-600 mr-2"></i>
                    Evaluation Meta
                </h3>
                <div class="space-y-4">
                    <div class="bg-gradient-to-r from-teal-50/50 to-cyan-50/50 rounded-xl p-4 border border-teal-50">
            ...
            <!-- Quick Navigation -->
            <div class="bg-gradient-to-br from-teal-600 to-cyan-600 rounded-3xl shadow-lg p-6 text-white">
                <h3 class="text-lg font-bold mb-4 flex items-center">
                    <i class="fa-solid fa-arrow-turn-up mr-2"></i>
                    Quick Navigation
                </h3>
                <div class="space-y-3">
                    <a href="{{ route('student.reports.index') }}" class="block w-full bg-white/20 hover:bg-white/30 px-4 py-3 rounded-xl transition-all duration-200 text-center font-semibold border border-white/20">
                        <i class="fa-solid fa-list mr-2"></i>All Monthly Evaluations
                    </a>
                    <a href="{{ route('student.dashboard') }}" class="block w-full bg-white text-teal-700 hover:bg-teal-50 px-4 py-3 rounded-xl transition-all duration-200 text-center font-semibold shadow-md">
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center">
                    <i class="fa-solid fa-clock-rotate-left text-teal-600 mr-2"></i>
                    Recent Evaluations
                </h3>
                @php
                ...
                @if($recentEvals->count() > 0)
                    <div class="space-y-3">
                        @foreach($recentEvals as $recentEval)
                            <a href="{{ route('student.reports.show', $recentEval->id) }}?type=evaluation" 
                               class="block p-4 bg-gradient-to-r from-gray-50 to-teal-50/30 rounded-xl hover:from-teal-50 hover:to-cyan-50 transition-all duration-200 border border-gray-200 hover:border-teal-300 hover:shadow-md">
                                <div class="flex items-center justify-between mb-2">
                                    <p class="text-sm font-bold text-gray-800">
                                        {{ \Carbon\Carbon::createFromDate($recentEval->evaluation_year, $recentEval->evaluation_month, 1)->format('F Y') }}
                                    </p>
                                    <span class="px-2 py-1 bg-white rounded-lg text-xs font-bold text-teal-600">
