<x-dashboard-layout title="Weekly Schedule">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-4">
        @foreach($schedulesByDay as $dayData)
            ...
            <div class="bg-white rounded-2xl shadow-sm overflow-hidden {{ $isToday ? 'ring-2 ring-vibrant-green' : '' }}">
                <!-- Day Header -->
                            ...
                            <div class="p-3 bg-{{ $color }}-50 border border-{{ $color }}-100 rounded-xl hover:shadow-md transition cursor-pointer"
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h4 class="font-semibold text-gray-800 text-xs truncate">{{ $schedule->course->title }}</h4>
