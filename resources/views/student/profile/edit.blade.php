    ...
    <div class="max-w-3xl space-y-6">
        ...
        <form action="{{ route('student.profile.update') }}" method="POST" class="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
            ...
            <div class="flex flex-col sm:flex-row gap-4 mt-8">
                ...
                <a href="{{ route('student.profile.show') }}" class="w-full sm:w-auto text-center px-6 py-4 border-2 border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition font-bold">
                    Cancel
                </a>
            </div>
        </form>
