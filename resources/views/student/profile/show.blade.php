    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            <p class="text-white/80 text-sm mb-1">Total Courses</p>
                            <p class="text-3xl font-bold">{{ $stats['total_courses'] }}</p>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4">
                            <p class="text-white/80 text-sm mb-1">Completed Sessions</p>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-6 border border-gray-100">
                ...
                <div class="space-y-3">
                    <a href="{{ route('student.profile.edit') }}" class="block w-full bg-gradient-to-r from-blue-100 to-purple-100 hover:from-blue-200 hover:to-purple-200 text-blue-700 px-4 py-3 rounded-xl transition-all font-semibold text-center">
                        <i class="fa-solid fa-user-edit mr-2"></i>Edit Profile
                    </a>
                    <a href="{{ route('student.dashboard') }}" class="block w-full bg-gradient-to-r from-green-100 to-emerald-100 hover:from-green-200 hover:to-emerald-200 text-green-700 px-4 py-3 rounded-xl transition-all font-semibold text-center">
