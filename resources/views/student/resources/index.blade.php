<x-dashboard-layout title="My Resources">
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                ...
                <p class="text-gray-600 text-sm">Educational resources assigned by your teachers</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('student.resources.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <!-- Search -->
            <div>
            ...
            <div class="flex gap-2 items-end">
                ...
                <a href="{{ route('student.resources.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition font-semibold">
    ...
    <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                ...
                @foreach($resources as $resource)
                    <div class="border border-gray-200 rounded-xl p-5 hover:shadow-lg transition">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('student.resources.show', $resource->id) }}" class="flex-1 bg-vibrant-green text-white px-4 py-2 rounded-lg hover:bg-deep-blue transition text-center text-sm font-semibold">
                                <i class="fa-solid fa-eye mr-1"></i>View
                            </a>
                            @if($resource->isFile())
                                <a href="{{ route('student.resources.download', $resource->id) }}" target="_blank" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition text-sm font-semibold">
                                    <i class="fa-solid fa-external-link-alt"></i>
                                </a>
                            @elseif($resource->isLink())
                                <a href="{{ $resource->external_url }}" target="_blank" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition text-sm font-semibold">
                                    <i class="fa-solid fa-external-link-alt"></i>
                                </a>
                            @endif
                        </div>
        ...
        @else
            <div class="text-center py-12">
                ...
                <p class="text-gray-400 text-sm">Your teachers haven't assigned any resources yet</p>
            </div>
        @endif
    </div>
</x-dashboard-layout>
