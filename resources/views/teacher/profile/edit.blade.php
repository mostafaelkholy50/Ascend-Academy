    ...
    <div class="max-w-3xl space-y-6">
        ...
        <div class="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex-1">
                    <form action="{{ route('teacher.profile.avatar.update') }}" method="POST" enctype="multipart/form-data" class="space-y-3">
                        @csrf
                        <div>
                    ...
                    @if($user->avatar)
                        <form action="{{ route('teacher.profile.avatar.delete') }}" method="POST" class="mt-2" onsubmit="return confirm('Are you sure you want to remove your profile picture?');">
                            @csrf
                            @method('DELETE')
        ...
        <form action="{{ route('teacher.profile.update') }}" method="POST" class="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
            @csrf
            @method('PATCH')
