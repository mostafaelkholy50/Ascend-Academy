<x-dashboard-layout title="My Hours">
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">My Hours & Earnings</h1>
                <p class="text-gray-600 text-sm">Track your worked hours and monthly earnings</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 mb-6">
        <form method="GET" action="{{ route('teacher.hours.index') }}" class="flex flex-wrap gap-4 items-end">
