    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
        ...
        <form id="attendanceForm" class="p-6 space-y-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <label for="teacherPresent" class="font-semibold text-gray-800 cursor-pointer">Teacher
                                Present</label>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" id="teacherPresent" name="teacher_present" value="1"
                            class="sr-only peer">
                        <div
                ...
                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <label for="studentPresent" class="font-semibold text-gray-800 cursor-pointer">Student
                                Present</label>
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <input type="checkbox" id="studentPresent" name="student_present" value="1"
                            class="sr-only peer">
                        <div
            ...
            <div class="flex items-center space-x-3 pt-4 border-t border-gray-100">
                ...
                <button type="submit" id="submitAttendance"
...
<script>
    ...
    document.getElementById('attendanceForm').addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                showSuccessMessage(data.message || 'Attendance marked successfully!');
    ...
    function showSuccessMessage(message) {
        ...
        toast.className =
            'fixed top-4 right-4 bg-gradient-to-r from-green-500 to-teal-500 text-white px-6 py-4 rounded-xl shadow-2xl z-50 flex items-center space-x-3 transform transition-all duration-500 ease-in-out opacity-0 translate-y-2';
        toast.innerHTML = `
    ...
    async function notifyWaiting(scheduleId) {
