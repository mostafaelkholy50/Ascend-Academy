...
1. Fetches all scheduled classes for the current day window.
...
- **Who calls it**: The Laravel Scheduler (Cron) runs `php artisan class:send-reminders` daily at `00:00`.
